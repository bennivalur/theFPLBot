...
def drawTeam(formation, players):
    ...
    #draw.ellipse(((field_with/2)-radius, penalty_spot-radius, (field_with/2)+radius, penalty_spot+radius),outline=(255, 255, 255),width=10)
    ...
    txt = gk1['short']
    #draw.rectangle((gk_w, gk_h+player_size, gk_w + player_size, gk_h + 30 + player_size), fill='black')
    ...
    for x in range(0,no_defenders):
        ...
        txt = p['short']
        draw.text((w+(w*x) ,d_h+player_size+20),txt,(0,0,0),anchor='ms',font=font)
    ...
    for x in range(0,no_midfielders):
        ...
        txt = p['short']
        draw.text((w+(w*x) ,m_h+player_size+20),txt,(0,0,0),anchor='ms',font=font)
    ...
    for x in range(0,no_forwards):
        ...
        txt = p['short']
        draw.text((w+(w*x) ,f_h+player_size+20),txt,(0,0,0),anchor='ms',font=font)
