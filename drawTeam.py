...
def drawTeam(formation, players,file_name,transfers):
    ...
    font = ImageFont.truetype("assets/Roboto-Black.ttf", 20)
    ...
    font = ImageFont.truetype("assets/Roboto-Black.ttf", 30)
    ...
    if(len(transfers) > 0):
        font = ImageFont.truetype("assets/Roboto-Black.ttf", 15)
        ...
        if transfers[0] != 'none':
            ...
            draw.text((field_width + transfers_width/2,gk_h+130 -text_buffer),'Transfer' + isPlural(transfers) + ' In',(0,0,0),anchor='ms',font=ImageFont.truetype("assets/Roboto-Black.ttf", 30))
            draw.text((field_width + transfers_width/2,s_h+160 ),'Transfer' + isPlural(transfers) + ' Out',(0,0,0),anchor='ms',font=ImageFont.truetype("assets/Roboto-Black.ttf", 30))

        else:
            draw.text((field_width + transfers_width/2,gk_h+130),'Amazing!' ,(0,0,0),anchor='ms',font=ImageFont.truetype("assets/Roboto-Black.ttf", 30))
            draw.text((field_width + transfers_width/2,gk_h+160),'I was not able to find any transfers' ,(0,0,0),anchor='ms',font=ImageFont.truetype("assets/Roboto-Black.ttf", 20))
            draw.text((field_width + transfers_width/2,gk_h+190),'to help make your team better' ,(0,0,0),anchor='ms',font=ImageFont.truetype("assets/Roboto-Black.ttf", 20))

        img = Image.open('assets/profilepic.PNG', 'r')
