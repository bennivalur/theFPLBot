...
async def main():
    async with aiohttp.ClientSession() as session:
        ...
        with open('tempfiles/understat2022.json', 'w') as file:
            file.write(players)

        
        main_table = pd.read_json('tempfiles/understat2022.json')
        main_table.to_csv('tempfiles/understat2022.csv',index=False)
